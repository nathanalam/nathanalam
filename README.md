...
export default {
  ...
  siteTitle: "Nathan Alam", // Main site title
  siteSubTitle: "Engineer in search of abundance", // Subtitle/tagline
  copyright: "© 2025 Nathan Alam", // Footer copyright text
...
| ------------------------------------ | ------- | --------------------- | -------------------------------------------- |
| **Basic Site Information**           |
| `siteTitle`                          | String  | "Nathan Alam"     | Main site title displayed in header          |
| `siteSubTitle`                       | String  | "Engineer for abundance..."  | Subtitle/tagline shown under title           |
