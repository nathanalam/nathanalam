export default {
  siteTitle: "Nathan Alam", // Main site title displayed in header
  siteSubTitle: "Engineer in search of Abundance", // Subtitle shown under main title
  copyright: "© 2025 Nathan Alam. All Rights Reserved.", // Footer copyright text
